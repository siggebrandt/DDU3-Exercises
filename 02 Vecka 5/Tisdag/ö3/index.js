class Book {
    ...
    set year(value) {
        if (value < 0) {
            ...
            console.error("year är inte ett positivt tal"); return;
        }
    ...
    get print() {
        return `${this._author} (${this._year}): ${this._title}`
    }
}
let b = new Book({ title: "the first ever book", author: "victor", year: 2020 });
